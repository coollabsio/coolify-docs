...
<ZoomableImage src="/docs/images/knowledge-base/cf-tunnel/all-resource/2.webp" alt="Screenshot of All Resource" />

You will be prompted to enter a tunnel name. Choose a name that you prefer.

<ZoomableImage src="/docs/images/knowledge-base/cf-tunnel/all-resource/3.webp" alt="Screenshot of All Resource" />

Next you will see the configuration page with multiple options to install cloudflared.

<ZoomableImage src="/docs/images/knowledge-base/cf-tunnel/all-resource/4.webp" alt="Screenshot of All Resource" />
...
<ZoomableImage src="/docs/images/knowledge-base/cf-tunnel/all-resource/5.webp" alt="Screenshot of All Resource" />

Scroll down until you see the **Next** button, then click it.

Then, you will be prompted to add a hostname.

<ZoomableImage src="/docs/images/knowledge-base/cf-tunnel/all-resource/6.webp" alt="Screenshot of All Resource" />
...
<ZoomableImage src="/docs/images/knowledge-base/cf-tunnel/all-resource/16.webp" alt="Screenshot of All Resource" />
...
<ZoomableImage src="/docs/images/knowledge-base/cf-tunnel/all-resource/8.webp" alt="Screenshot of All Resource" />

You will see many options to deploy a new app. Search for Cloudflared and click on it.

<ZoomableImage src="/docs/images/knowledge-base/cf-tunnel/all-resource/9.webp" alt="Screenshot of All Resource" />
...
<ZoomableImage src="/docs/images/knowledge-base/cf-tunnel/all-resource/13.webp" alt="Screenshot of All Resource" />

First, copy your tunnel ID from the Tunnels page on the Cloudflare dashboard.

<ZoomableImage src="/docs/images/knowledge-base/cf-tunnel/all-resource/14.webp" alt="Screenshot of All Resource" />
