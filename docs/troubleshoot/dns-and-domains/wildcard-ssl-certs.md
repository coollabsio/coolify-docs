...
description: Troubleshoot wildcard SSL certificate issues in Coolify by verifying certificate installation, checking proxy configuration, and clearing browser cache problems.
---
