...
- Have followed our [Tunnel All Resources Using Cloudflare Tunnel](/integrations/networking/cloudflare/tunnels/all-resource) or [Tunnel Specific Resources Using Cloudflare Tunnel](/integrations/networking/cloudflare/tunnels/single-resource) guide.
...
<ZoomImage src="/docs/images/integrations/security/cloudflare/ddos-protection/cf-origin-certificate-overview-diagram.webp" />

---

## A. Create Cloudflare Origin Certificate [!toc]
<ZoomImage src="/docs/images/integrations/security/cloudflare/ddos-protection/1.webp" />
...
<ZoomImage src="/docs/images/integrations/security/cloudflare/ddos-protection/2.webp" />
...
<ZoomImage src="/docs/images/integrations/security/cloudflare/ddos-protection/3.webp" />
...
<ZoomImage src="/docs/images/integrations/security/cloudflare/ddos-protection/8.webp" />
...
<ZoomImage src="/docs/images/integrations/security/cloudflare/ddos-protection/9.webp" />
...
<ZoomImage src="/docs/images/integrations/security/cloudflare/ddos-protection/10.webp" />
...
A simple high-level overview diagram to give you a visual idea of how this works:
<ZoomImage src="/docs/images/integrations/security/cloudflare/ddos-protection/public-ca-origin-certificate-overview-diagram.webp" />

We already have guides to set up DNS challenge for TLS certificates, you can follow them here:

- [Traefik DNS challenge](/core/networking/proxy/traefik/dns-challenge)
- [Caddy DNS challenge](/core/networking/proxy/caddy/dns-challenge)
...
<ZoomImage src="/docs/images/integrations/security/cloudflare/ddos-protection/5.webp" />

1. Go to **SSL/TLS** in Cloudflare.
2. Select **Overview**.
3. Click **Configure** button

<ZoomImage src="/docs/images/integrations/security/cloudflare/ddos-protection/6.webp" />
...
<ZoomImage src="/docs/images/integrations/security/cloudflare/ddos-protection/7.webp" />
...
<ZoomImage src="/docs/images/integrations/networking/cloudflare/tunnels/full-tls/17.webp" />
...
<ZoomImage src="/docs/images/integrations/networking/cloudflare/tunnels/full-tls/18.webp" />
...
<ZoomImage src="/docs/images/integrations/networking/cloudflare/tunnels/full-tls/10.webp" />

<br />

<ZoomImage src="/docs/images/integrations/networking/cloudflare/tunnels/full-tls/11.webp" />
