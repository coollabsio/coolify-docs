...
If you wish to connect to databases hosted on Coolify, but external to the Superset service template, you will need to turn on the option: [Connect to Predefined Network](/applications/builds/docker-compose#application-networking).
