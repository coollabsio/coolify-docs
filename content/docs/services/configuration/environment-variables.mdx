...
Link Doppler, Infisical, or HashiCorp Vault and reference a remote value with `{{vault.KEY}}`. The source applies to the whole Service stack. Follow [Use a secret manager](/integrations/security/using-secret-managers).
