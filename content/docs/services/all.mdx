...
- [Engram](/services/engram) - Persistent memory sync server for AI coding agents (MCP).
- [Flowise](/services/flowise) - Drag & drop UI to build your customized LLM flow.
- [Hermes Agent](/services/hermes-agent) - Autonomous AI agent from Nous Research with persistent memory, scheduling, and a web interface. Available as a two-container WebUI stack or a single-container dashboard.
...
- [Snipe-IT](/services/snipe-it) - A free open source IT asset/license management system 
...
- [InfluxDB](/services/influxdb) - Open-source time series database for metrics, events, and IoT data.
...
- [Bulwark](/services/bulwark) - Modern webmail client for Stalwart Mail Server built on the JMAP protocol.
...
- [Stalwart](/services/stalwart) - All-in-one mail server with SMTP, IMAP, POP3, JMAP, Sieve, built-in anti-spam, and a web admin interface.
...
- [Lidarr](/services/lidarr) - Music collection manager for Usenet and BitTorrent users.
...
- [Solidtime](/services/solidtime) - Modern open-source time tracking for freelancers, agencies and teams.
