...
description: "Create or replace service storage volume backup schedule"
---

# Storage set backup

Create or replace service storage volume backup schedule

## Usage

```sh
coolify service storage set-backup <service_uuid> <storage_uuid>
```
...
```sh
coolify service storage set-backup --help
```
