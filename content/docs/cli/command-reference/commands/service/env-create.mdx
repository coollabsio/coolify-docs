...
Create a new environment variable for a specific service. Use --key and --value flags to specify the variable.

## Usage

```sh
coolify service env create <service_uuid>
```
...
```sh
coolify service env create --help
```
