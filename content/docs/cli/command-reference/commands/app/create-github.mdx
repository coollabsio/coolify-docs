...
| `--git-repository` | `string` | Yes | — | Git repository in format 'owner/repo' (required) |
| `--github-app-uuid` | `string` | Yes | — | GitHub App UUID (required) |
...
```sh
coolify app create github --help
```
