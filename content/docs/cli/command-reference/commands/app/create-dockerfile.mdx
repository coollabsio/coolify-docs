...
Create an application from a custom Dockerfile
...
| `--dockerfile` | `string` | Yes | — | Dockerfile content (required) |
...
| `--ports-exposes` | `string` | No | — | Exposed ports, e.g., '3000' or '3000,8080' |
...
```sh
coolify app create dockerfile --help
```
