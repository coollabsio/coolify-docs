...
Before following this guide, make sure you read the [self-hosted setup guide](/start-with-self-hosted) to ensure your system meets all requirements.
...
<Tabs items={['Stop the conflicting service', 'Change Coolify port']}>
<Tab value="Stop the conflicting service">
...
<Accordion title="Script completes but no access URL shown">
...
See [Check Port Availability](#check-port-availability) above.

</Accordion>

<Accordion title="Docker image pull failures">
...
<Accordion title="SSH configuration problems">
...
If it shows `permitrootlogin no`, see the [OpenSSH Configuration Guide](/core/infrastructure/servers/openssh).
...
<Tabs items={['Retry without reset', 'Clean re-installation', 'Manual installation']}>
<Tab value="Retry without reset">
...
<Tab value="Clean re-installation">
...
Follow the [Uninstallation Guide](/core/instance-management/uninstallation) to properly remove Coolify, then re-run the installation script:
...
If the automated script continues to fail, try the [manual installation](/start-with-self-hosted#manual-installation) method.
...
- [Self-hosted setup guide](/start-with-self-hosted)
- [Manual Installation](/start-with-self-hosted#manual-installation)
- [Firewall Configuration](/core/infrastructure/servers/firewall)
- [OpenSSH Configuration](/core/infrastructure/servers/openssh)
