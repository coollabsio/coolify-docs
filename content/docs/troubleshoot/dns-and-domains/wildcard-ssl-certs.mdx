...
### Check the Coolify Proxy Configuration

- **Add Certificate in Dashboard:** Make sure you have added the SSL certificate configuration in the Coolify proxy via the dashboard. More details can be found [here](/core/networking/proxy/traefik/custom-ssl-certs).
