...
### Test with Your Server’s IP Address
...
- **Observation:**
  - If you see the login page, the dashboard is working fine without proxy (skip to [step 4](#addressing-proxy-related-issues)).
  - If you don't see the login page, the issue might be with your server or coolify docker containers.

</Step>
<Step>

### Check the Coolify Container
...
- **Test:** After restarting, try accessing `http://203.0.113.1:8000` _(Replace `203.0.113.1` with your actual server IP address)_ again. If this doesn't work, skip to [step 5](#getting-further-assistance)
...
### Addressing Proxy-Related Issues
