...
<Tab value="Root user" icon={ShieldSecurity2}>
...
<Tab value="Custom Docker network" icon={Globe3}>
...
<Tab value="Custom registry source" icon={Box2}>
...
<Tab value="Compose overrides" icon={PenNib}>
