...
Link Doppler, Infisical, or HashiCorp Vault and reference a remote value with `{{vault.KEY}}`. Follow [Use a secret manager](/integrations/security/using-secret-managers).
